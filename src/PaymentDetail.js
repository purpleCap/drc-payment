  ...
  return (
    <View style={{...styles.container, height: windHeight, justifyContent: 'center', alignSelf:'center'}}>
        <View style={{ marginVertical: 10}}>
            ...
            <View style={{display: 'flex', flexDirection:'row'}}>
                <Text style={{fontSize: 20, fontWeight:'500'}}>CID</Text>
                <Text style={{fontSize: 20, fontWeight:'500', color: 'blue'}}>{" "}345555678</Text>
            </View>
            <View style={{display: 'flex', flexDirection:'row'}}>
                <Text style={{fontSize: 20, fontWeight:'500'}}>TPN</Text>
                <Text style={{fontSize: 20, fontWeight:'500', color: 'blue'}}>{" "}345555678</Text>
            </View>
            <View style={{display: 'flex', flexDirection:'row'}}>
